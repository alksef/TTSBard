...
function showMessage(msg: string, type: Exclude<HotkeyMessageType, null>) {
      ...
      <div class="hotkey-row">
        ...
        <div class="hotkey-actions">
          ...
          <button
            ...
            class="cancel-btn"
            :title="t('hotkeys.action.cancel_esc')"
          >
            ✕
          </button>
      ...
      <div class="hotkey-row">
        ...
        <div class="hotkey-actions">
          ...
          <button
            ...
            class="cancel-btn"
            :title="t('hotkeys.action.cancel_esc')"
            :aria-label="t('hotkeys.action.cancel_aria')"
          >
            ✕
          </button>
