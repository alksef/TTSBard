...
// Suppress all warnings for the vendored tract-core crate because it is a third-party
// registry dependency that we patch locally. Since Cargo treats path dependencies
// as part of the workspace, it would otherwise emit compiler warnings for code we do not own.
#![allow(warnings)]
//! # Tract
//!
