...
Исследование завершено, CodeMirror выбран.
...
> **Важно:** этот файл — исследование, а не task. Реализация была передана
> DeepSeek отдельным локальным заданием; актуальный процесс описан в
