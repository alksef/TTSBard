...
## 3. Сценарии реализации Липсинка (Lip-Sync)
...
## 4. Архитектура интеграции в TTSBard: Выбор в пользу Бэкенда (Rust)
...
## 5. Техническая реализация на бэкенде
...
## 6. Схема конфигурации (`settings.json`)
