...
- **Масштабируемый саундпад:**
  - Поддержка создания и переключения независимых наборов звуков (Sound Sets).
  - Инлайн-редактирование привязок клавиш (A-Z) к файлам непосредственно в интерфейсе.
- **Расширенный AI-функционал:**
  - Интеграция новых провайдеров искусственного интеллекта (OpenAI, DeepSeek, Z.ai).

### Changed

- **Редизайн логики ввода:**
  - Полностью удален концепт фонового перехвата ввода текста (`Ctrl+Shift+F1`) и отдельное плавающее окно ввода.
  - Реализован мгновенный вызов основного окна с редактором по `Ctrl+Shift+F3` и закрытие с возвратом фокуса в игру по `Escape`.
